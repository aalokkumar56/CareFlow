...
const SCREENSHOT_DIR = path.join(__dirname, "screenshots", "notifications");
...
test.describe("Notifications bell dropdown", () => {
  ...
  test("bell badge, unread/read styling, scroll, and preferences link", async ({ page }) => {
    ...
    await page.screenshot({ path: screenshotPath("01-bell-with-badge"), fullPage: false });
    ...
    await page.screenshot({ path: screenshotPath("02-dropdown-unread-styling"), fullPage: false });
    ...
    await page.screenshot({ path: screenshotPath("03-dropdown-scrolled"), fullPage: false });
    ...
    await page.screenshot({ path: screenshotPath("04-dropdown-read-styling"), fullPage: false });
  });
  ...
  test("user without Settings access can open preferences from bell", async ({ page }) => {
    ...
    await page.screenshot({ path: screenshotPath("05-nurse-preferences-page"), fullPage: false });
